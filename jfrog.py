...
def jfrogUpload() :
    ...
    url = 'http://52.86.169.160:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    file_path = '/var/lib/jenkins/workspace/Test_Assignment/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    username = 'admin'
